...
import { ScheduleDigitalDownloadableProductDropService } from '../../../../../../src/api/app/digitalDownloadableProduct/commands/admin/scheduleDigitalDownloadableProductDropService'
import type { ScheduleDigitalDownloadableProductDropCommand } from '../../../../../../src/api/app/digitalDownloadableProduct/commands/admin/commands'
import { setupTestEnvironment, createTestProduct, createTestVariant } from './helpers'
import { closeTestDatabase } from '../../../../../helpers/database'

describe('ScheduleDigitalDownloadableProductDropService', () => {
  test('should schedule a hidden drop for a product with variants', async () => {
    ...
    try {
      ...
      const service = new ScheduleDigitalDownloadableProductDropService(unitOfWork)
      const command: ScheduleDigitalDownloadableProductDropCommand = {
        type: 'scheduleDigitalDownloadableProductDrop',
        id: productId,
        correlationId: randomUUIDv7(),
        userId: 'user-123',
        dropType: 'hidden',
