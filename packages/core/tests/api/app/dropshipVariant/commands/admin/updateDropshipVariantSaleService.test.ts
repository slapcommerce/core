...
import { UpdateDropshipVariantSaleService } from '../../../../../../src/api/app/dropshipVariant/commands/admin/updateDropshipVariantSaleService'
import { setupTestEnvironment, createTestProduct, createTestVariant } from './helpers'

describe('UpdateDropshipVariantSaleService', () => {
  test('should update variant sale with fixed price', async () => {
    ...
    try {
      ...
      const service = new UpdateDropshipVariantSaleService(unitOfWork)

      await service.execute({
        type: 'updateDropshipVariantSale',
        id: variant.id,
        userId: 'user-123',
        saleType: 'fixed',
        saleValue: 999,
