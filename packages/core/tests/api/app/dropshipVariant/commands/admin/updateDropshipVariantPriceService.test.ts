...
import { UpdateDropshipVariantPriceService } from '../../../../../../src/api/app/dropshipVariant/commands/admin/updateDropshipVariantPriceService'
import { setupTestEnvironment, createTestProduct, createTestVariant } from './helpers'

describe('UpdateDropshipVariantPriceService', () => {
  test('should update variant price', async () => {
    ...
    try {
      ...
      const service = new UpdateDropshipVariantPriceService(unitOfWork)

      await service.execute({
        type: 'updateDropshipVariantPrice',
        id: variant.id,
        userId: 'user-123',
        price: 2999,
        expectedVersion: 0,
