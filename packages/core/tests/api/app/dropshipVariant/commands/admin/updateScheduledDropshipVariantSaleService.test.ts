...
import { UpdateScheduledDropshipVariantSaleService } from '../../../../../../src/api/app/dropshipVariant/commands/admin/updateScheduledDropshipVariantSaleService'
import { setupTestEnvironment, createTestProduct, createTestVariant } from './helpers'

describe('UpdateScheduledDropshipVariantSaleService', () => {
  test('should update both schedule dates', async () => {
    ...
    try {
      ...
      const updateService = new UpdateScheduledDropshipVariantSaleService(unitOfWork)
      await updateService.execute({
        type: 'updateScheduledDropshipVariantSale',
        id: variant.id,
        userId: 'user-123',
