...
import { UpdateVariantInventoryService } from '../../../../../../src/api/app/variant/commands/admin/updateVariantInventoryService'
...
import type { UpdateVariantInventoryCommand } from '../../../../../../src/api/app/variant/commands/admin/commands'
...
describe('UpdateVariantInventoryService', () => {
  test('should successfully update variant inventory', async () => {
    ...
    try {
      ...
      expect(events[0].eventType).toBe('variant.inventory_updated')
