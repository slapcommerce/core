...
import { AttachVariantDigitalAssetService } from '../../../../../../src/api/app/variant/commands/admin/attachVariantDigitalAssetService'
...
import type { AttachVariantDigitalAssetCommand } from '../../../../../../src/api/app/variant/commands/admin/commands'
...
describe('AttachVariantDigitalAssetService', () => {
  test('should successfully attach digital asset to variant for digital product', async () => {
    ...
    try {
      ...
      expect(events[0].eventType).toBe('variant.digital_asset_attached')
