...
import { DetachVariantDigitalAssetService } from '../../../../../../src/api/app/variant/commands/admin/detachVariantDigitalAssetService'
import { VariantAggregate } from '../../../../../../src/api/domain/variant/aggregate'
import type { DetachVariantDigitalAssetCommand } from '../../../../../../src/api/app/variant/commands/admin/commands'
...
describe('DetachVariantDigitalAssetService', () => {
  test('should successfully detach digital asset from variant', async () => {
    ...
    try {
      ...
      expect(events[0].eventType).toBe('variant.digital_asset_detached')
