...
import { UpdateVariantDetailsService } from '../../../../../../src/api/app/variant/commands/admin/updateVariantDetailsService'
...
import type { UpdateVariantDetailsCommand } from '../../../../../../src/api/app/variant/commands/admin/commands'
...
describe('UpdateVariantDetailsService', () => {
  test('should successfully update variant options', async () => {
    ...
    try {
      ...
      expect(events[0].eventType).toBe('variant.details_updated')
