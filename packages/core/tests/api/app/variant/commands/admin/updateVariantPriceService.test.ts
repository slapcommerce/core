...
import { UpdateVariantPriceService } from '../../../../../../src/api/app/variant/commands/admin/updateVariantPriceService'
import { VariantAggregate } from '../../../../../../src/api/domain/variant/aggregate'
import type { UpdateVariantPriceCommand } from '../../../../../../src/api/app/variant/commands/admin/commands'
...
describe('UpdateVariantPriceService', () => {
  test('should successfully update variant price', async () => {
    ...
    try {
      ...
      expect(events[0].eventType).toBe('variant.price_updated')
