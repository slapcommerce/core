...
import { UpdateVariantSkuService } from '../../../../src/api/app/variant/updateVariantSkuService'
import { VariantAggregate } from '../../../../src/api/domain/variant/aggregate'
import type { UpdateVariantSkuCommand } from '../../../../src/api/app/variant/commands'
...
describe('UpdateVariantSkuService', () => {
  test('should successfully update variant SKU', async () => {
    ...
    try {
      ...
      expect(events[0].event_type).toBe('variant.sku_updated')
