...
import { CreateVariantService } from '../../../../src/api/app/variant/createVariantService'
import { ProductAggregate } from '../../../../src/api/domain/product/aggregate'
import { SkuAggregate } from '../../../../src/api/domain/sku/skuAggregate'
import type { CreateVariantCommand } from '../../../../src/api/app/variant/commands'
...
describe('CreateVariantService', () => {
  test('should successfully create a new variant with SKU', async () => {
    ...
    try {
      ...
      expect(variantSnapshot.correlation_id).toBe(command.correlationId)
      ...
      expect(variantEvents[0].event_type).toBe('variant.created')
  ...
  test('should create both variant and SKU snapshots', async () => {
    ...
    try {
      ...
      const aggregateIds = snapshots.map(s => s.aggregate_id)
