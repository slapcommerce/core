...
import { UpdateProductTagsService } from '../../../../../../src/api/app/product/commands/admin/updateProductTagsService'
import { ProductAggregate } from '../../../../../../src/api/domain/product/aggregate'
import type { UpdateProductTagsCommand } from '../../../../../../src/api/app/product/commands/admin/commands'
...
describe('UpdateProductTagsService', () => {
  test('should successfully update product tags', async () => {
    ...
    try {
      ...
      expect(events[0].eventType).toBe('product.tags_updated')
