...
import { UpdateCollectionSeoMetadataService } from '../../../../src/api/app/collection/updateCollectionSeoMetadataService'
import { CollectionAggregate } from '../../../../src/api/domain/collection/aggregate'
import type { UpdateCollectionSeoMetadataCommand } from '../../../../src/api/app/collection/commands'
  ...
  test('should successfully update SEO metadata', async () => {
    ...
    try {
      ...
      const events = db.query(`
        SELECT * FROM events
        WHERE aggregate_id = ? AND event_type = 'collection.seo_metadata_updated'
