...
import { ArchiveCollectionService } from '../../../../src/api/app/collection/archiveCollectionService'
import { CollectionAggregate } from '../../../../src/api/domain/collection/aggregate'
import type { ArchiveCollectionCommand } from '../../../../src/api/app/collection/commands'
  ...
  test('should successfully archive draft collection', async () => {
    ...
    try {
      ...
      const events = db.query(`
        SELECT * FROM events
        WHERE aggregate_id = ? AND event_type = 'collection.archived'
