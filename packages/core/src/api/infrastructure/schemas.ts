export const schemas = [
  ...
  // Pending schedules read model for the new domain-embedded scheduling system
  `CREATE TABLE IF NOT EXISTS pendingSchedulesReadModel (
  ...
  `CREATE INDEX IF NOT EXISTS idx_pendingSchedules_status_dueAt ON pendingSchedulesReadModel(status, dueAt)`,
  `CREATE INDEX IF NOT EXISTS idx_pendingSchedules_aggregateId ON pendingSchedulesReadModel(aggregateId)`,
  `CREATE INDEX IF NOT EXISTS idx_pendingSchedules_scheduleGroupId ON pendingSchedulesReadModel(scheduleGroupId)`,
];
