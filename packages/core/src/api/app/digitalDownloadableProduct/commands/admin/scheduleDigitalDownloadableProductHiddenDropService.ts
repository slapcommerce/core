...
import type { ScheduleDigitalDownloadableProductHiddenDropCommand } from "./commands";
...
export class ScheduleDigitalDownloadableProductHiddenDropService {
  constructor(private unitOfWork: UnitOfWork) {
    this.unitOfWork = unitOfWork;
  }

  async execute(command: ScheduleDigitalDownloadableProductHiddenDropCommand) {
