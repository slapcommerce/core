...
import type { ArchiveDigitalDownloadableProductCommand } from "./commands";
import { DigitalDownloadableProductAggregate } from "../../../../domain/digitalDownloadableProduct/aggregate";
import { randomUUIDv7 } from "bun";
import type { Service } from "../../../service";

export class ArchiveDigitalDownloadableProductService
  implements Service<ArchiveDigitalDownloadableProductCommand>
{
  constructor(private unitOfWork: UnitOfWork) {
    this.unitOfWork = unitOfWork;
  }

  async execute(command: ArchiveDigitalDownloadableProductCommand) {
