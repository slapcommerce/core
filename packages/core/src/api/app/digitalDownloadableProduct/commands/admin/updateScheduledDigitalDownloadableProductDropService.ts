...
import type { UpdateScheduledDigitalDownloadableProductDropCommand } from "./commands";
import { DigitalDownloadableProductAggregate } from "../../../../domain/digitalDownloadableProduct/aggregate";
import { randomUUIDv7 } from "bun";

export class UpdateScheduledDigitalDownloadableProductDropService {
  constructor(private unitOfWork: UnitOfWork) {}

  async execute(command: UpdateScheduledDigitalDownloadableProductDropCommand) {
