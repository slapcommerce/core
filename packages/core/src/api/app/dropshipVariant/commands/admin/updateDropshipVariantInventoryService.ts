...
import type { UpdateDropshipVariantInventoryCommand } from "./commands";
import { DropshipVariantAggregate } from "../../../../domain/dropshipVariant/aggregate";
import { randomUUIDv7 } from "bun";
import type { Service } from "../../../service";

export class UpdateDropshipVariantInventoryService implements Service<UpdateDropshipVariantInventoryCommand> {

  constructor(private unitOfWork: UnitOfWork) {}

  async execute(command: UpdateDropshipVariantInventoryCommand) {
