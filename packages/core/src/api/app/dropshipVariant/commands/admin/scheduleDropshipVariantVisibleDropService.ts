...
import type { ScheduleDropshipVariantVisibleDropCommand } from "./commands";
...
export class ScheduleDropshipVariantVisibleDropService {
  constructor(private unitOfWork: UnitOfWork) {}

  async execute(command: ScheduleDropshipVariantVisibleDropCommand) {
