...
import type { CancelScheduledDropshipVariantDropCommand } from "./commands";
import { DropshipVariantAggregate } from "../../../../domain/dropshipVariant/aggregate";
import { randomUUIDv7 } from "bun";

export class CancelScheduledDropshipVariantDropService {
  constructor(private unitOfWork: UnitOfWork) {}

  async execute(command: CancelScheduledDropshipVariantDropCommand) {
