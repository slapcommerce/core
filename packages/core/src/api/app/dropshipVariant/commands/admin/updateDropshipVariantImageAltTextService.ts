...
import type { UpdateDropshipVariantImageAltTextCommand } from "./commands";
import { DropshipVariantAggregate } from "../../../../domain/dropshipVariant/aggregate";
import { randomUUIDv7 } from "bun";
import type { Service } from "../../../service";

export class UpdateDropshipVariantImageAltTextService implements Service<UpdateDropshipVariantImageAltTextCommand> {

  constructor(private unitOfWork: UnitOfWork) {}

  async execute(command: UpdateDropshipVariantImageAltTextCommand) {
