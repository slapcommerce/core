...
import type { UpdateScheduledDropshipVariantSaleCommand } from "./commands";
import { DropshipVariantAggregate } from "../../../../domain/dropshipVariant/aggregate";
import { randomUUIDv7 } from "bun";

export class UpdateScheduledDropshipVariantSaleService {
  constructor(private unitOfWork: UnitOfWork) {}

  async execute(command: UpdateScheduledDropshipVariantSaleCommand) {
