...
import type { UpdateDigitalDownloadableVariantDetailsCommand } from "./commands";
import { DigitalDownloadableVariantAggregate } from "../../../../domain/digitalDownloadableVariant/aggregate";
import { randomUUIDv7 } from "bun";
import type { Service } from "../../../service";

export class UpdateDigitalDownloadableVariantDetailsService implements Service<UpdateDigitalDownloadableVariantDetailsCommand> {

  constructor(private unitOfWork: UnitOfWork) {}

  async execute(command: UpdateDigitalDownloadableVariantDetailsCommand) {
