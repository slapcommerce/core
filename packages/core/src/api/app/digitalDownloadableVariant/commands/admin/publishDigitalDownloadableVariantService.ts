...
import type { PublishDigitalDownloadableVariantCommand } from "./commands";
import { DigitalDownloadableVariantAggregate } from "../../../../domain/digitalDownloadableVariant/aggregate";
import { randomUUIDv7 } from "bun";
import type { Service } from "../../../service";

export class PublishDigitalDownloadableVariantService implements Service<PublishDigitalDownloadableVariantCommand> {

  constructor(private unitOfWork: UnitOfWork) {}

  async execute(command: PublishDigitalDownloadableVariantCommand) {
