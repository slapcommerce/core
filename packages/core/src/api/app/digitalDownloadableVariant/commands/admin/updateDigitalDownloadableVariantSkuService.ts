...
import type { UpdateDigitalDownloadableVariantSkuCommand } from "./commands";
...
export class UpdateDigitalDownloadableVariantSkuService implements Service<UpdateDigitalDownloadableVariantSkuCommand> {

  constructor(private unitOfWork: UnitOfWork) {}

  async execute(command: UpdateDigitalDownloadableVariantSkuCommand) {
