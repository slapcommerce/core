...
import type { UpdateScheduledDigitalDownloadableVariantDropCommand } from "./commands";
import { DigitalDownloadableVariantAggregate } from "../../../../domain/digitalDownloadableVariant/aggregate";
import { randomUUIDv7 } from "bun";

export class UpdateScheduledDigitalDownloadableVariantDropService {
  constructor(private unitOfWork: UnitOfWork) {}

  async execute(command: UpdateScheduledDigitalDownloadableVariantDropCommand) {
