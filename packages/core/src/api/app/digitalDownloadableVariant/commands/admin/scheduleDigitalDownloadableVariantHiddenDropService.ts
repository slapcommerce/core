...
import type { ScheduleDigitalDownloadableVariantHiddenDropCommand } from "./commands";
...
export class ScheduleDigitalDownloadableVariantHiddenDropService {
  constructor(private unitOfWork: UnitOfWork) {}

  async execute(command: ScheduleDigitalDownloadableVariantHiddenDropCommand) {
