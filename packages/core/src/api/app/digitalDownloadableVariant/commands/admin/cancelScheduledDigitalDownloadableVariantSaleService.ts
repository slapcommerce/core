...
import type { CancelScheduledDigitalDownloadableVariantSaleCommand } from "./commands";
import { DigitalDownloadableVariantAggregate } from "../../../../domain/digitalDownloadableVariant/aggregate";
import { randomUUIDv7 } from "bun";

export class CancelScheduledDigitalDownloadableVariantSaleService {
  constructor(private unitOfWork: UnitOfWork) {}

  async execute(command: CancelScheduledDigitalDownloadableVariantSaleCommand) {
