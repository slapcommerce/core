...
import type { AddDigitalDownloadableVariantImageCommand } from "./commands";
...
export class AddDigitalDownloadableVariantImageService implements Service<AddDigitalDownloadableVariantImageCommand> {
  ...
  async execute(command: AddDigitalDownloadableVariantImageCommand) {
