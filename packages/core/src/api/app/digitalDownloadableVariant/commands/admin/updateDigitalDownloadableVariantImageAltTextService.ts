...
import type { UpdateDigitalDownloadableVariantImageAltTextCommand } from "./commands";
import { DigitalDownloadableVariantAggregate } from "../../../../domain/digitalDownloadableVariant/aggregate";
import { randomUUIDv7 } from "bun";
import type { Service } from "../../../service";

export class UpdateDigitalDownloadableVariantImageAltTextService implements Service<UpdateDigitalDownloadableVariantImageAltTextCommand> {

  constructor(private unitOfWork: UnitOfWork) {}

  async execute(command: UpdateDigitalDownloadableVariantImageAltTextCommand) {
    return await this.unitOfWork.withTransaction(async (repositories) => {
      ...
      // Get current images and update alt text
