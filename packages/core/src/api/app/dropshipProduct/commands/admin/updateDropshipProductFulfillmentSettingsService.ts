...
import type { UpdateDropshipProductFulfillmentSettingsCommand } from "./commands";
import { DropshipProductAggregate } from "../../../../domain/dropshipProduct/aggregate";
import { randomUUIDv7 } from "bun";
import type { Service } from "../../../service";

export class UpdateDropshipProductFulfillmentSettingsService
  implements Service<UpdateDropshipProductFulfillmentSettingsCommand>
{
  constructor(private unitOfWork: UnitOfWork) {
    this.unitOfWork = unitOfWork;
  }

  async execute(command: UpdateDropshipProductFulfillmentSettingsCommand) {
    return await this.unitOfWork.withTransaction(async (repositories) => {
      ...
      productAggregate.updateFulfillmentSettings(
