...
import type { UnpublishDropshipProductCommand } from "./commands";
import { DropshipProductAggregate } from "../../../../domain/dropshipProduct/aggregate";
import { randomUUIDv7 } from "bun";
import type { Service } from "../../../service";

export class UnpublishDropshipProductService
  implements Service<UnpublishDropshipProductCommand>
{
  constructor(private unitOfWork: UnitOfWork) {
    this.unitOfWork = unitOfWork;
  }

  async execute(command: UnpublishDropshipProductCommand) {
