...
import type { ScheduleDropshipProductDropCommand } from "./commands";
...
export class ScheduleDropshipProductDropService {
  constructor(private unitOfWork: UnitOfWork) {}

  async execute(command: ScheduleDropshipProductDropCommand) {
