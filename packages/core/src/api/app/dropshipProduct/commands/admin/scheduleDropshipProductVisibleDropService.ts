...
import type { ScheduleDropshipProductVisibleDropCommand } from "./commands";
...
export class ScheduleDropshipProductVisibleDropService {
  constructor(private unitOfWork: UnitOfWork) {
    this.unitOfWork = unitOfWork;
  }

  async execute(command: ScheduleDropshipProductVisibleDropCommand) {
