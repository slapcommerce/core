...
interface CollectionSchedulesDialogProps {
  open: boolean;
...
const ACTION_LABELS: Record<string, string> = {
  publishCollection: "publish this collection",
  unpublishCollection: "unpublish this collection",
  archiveCollection: "archive this collection",
};
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              prevent the collection from being{" "}
              {actionLabel.replace("this collection", "")}.
            </DialogDescription>
          </DialogHeader>
...
export function CollectionSchedulesDialog({
  open,
  onOpenChange,
  collectionId,
  collectionTitle,
}: CollectionSchedulesDialogProps) {
  const { data: schedules, isLoading } = useCollectionSchedules(collectionId);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            View and manage scheduled actions for "{collectionTitle}"
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          {!isLoading && schedules && schedules.length === 0 && (
            <div className="text-center text-muted-foreground py-8">
              No scheduled actions for this collection
            </div>
          )}
