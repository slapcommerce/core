import type { DomainEvent, EventType } from "../../domain/_base/domainEvent"
...
export class CollectionsListViewProjection {
  constructor(private repositories: UnitOfWorkRepositories) { }

  async execute(
    event: CollectionEvent
  ): Promise<void> {
    const { collectionsListViewRepository } = this.repositories;
