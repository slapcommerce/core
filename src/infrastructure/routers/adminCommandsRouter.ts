...
export function createAdminCommandsRouter(
  ...
  const archiveProductService = new ArchiveProductService(unitOfWork, projectionService)
  const publishProductService = new PublishProductService(unitOfWork, projectionService)
  const changeSlugService = new ChangeSlugService(unitOfWork, projectionService)
  const updateProductDetailsService = new UpdateProductDetailsService(unitOfWork, projectionService)
  const updateProductMetadataService = new UpdateProductMetadataService(unitOfWork, projectionService)
  const updateProductClassificationService = new UpdateProductClassificationService(unitOfWork, projectionService)
  const updateProductTagsService = new UpdateProductTagsService(unitOfWork, projectionService)
  const updateProductShippingSettingsService = new UpdateProductShippingSettingsService(unitOfWork, projectionService)
  ...
  const updateVariantDetailsService = new UpdateVariantDetailsService(unitOfWork, projectionService)
